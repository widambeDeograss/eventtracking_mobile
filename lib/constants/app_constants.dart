class AppConstants {
  ...
  // API URLS
  static const String apiBaseUrl = 'http://192.168.10.123:8000/';
  static const String mediaBaseUrl = 'http://192.168.10.123:8000';
  static const String nidaBaseUrl = 'http://192.168.10.123:5000/api/nida_info';
  static const String verifyPhoneUrl = 'user-management/register';
  static const String apiUserLogin = 'http://192.168.10.123:8000/api/auth/login';
  static const String apiUserRegistration =
      'http://192.168.10.123:8000/api/auth/register';
  static const String apiUserVerifyOtp =
      'http://192.168.10.123:8000/app/citizen/auth/verify_user_otp';
